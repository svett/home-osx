...
class ModeHandler {
    ...
    constructor() {
        ...
        this.identity = new editorIdentity_1.EditorIdentity(vscode.window.activeTextEditor);
        ...
        this._modes = [
            ...
            new modeEasyMotion_1.EasyMotionInputMode(),
            ...
            if (configuration_1.Configuration.overrideCopy) {
                ...
                if (process.platform !== 'darwin' && key === '<C-c>') {
                    if (!configuration_1.Configuration.useCtrlKeys ||
                        this._vimState.currentMode === mode_1.ModeName.Visual ||
                        this._vimState.currentMode === mode_1.ModeName.VisualBlock ||
            ...
            try {
                ...
                if (!this._vimState.isCurrentlyPerformingRemapping && (withinTimeout || keys.length === 1)) {
                    ...
                    if (!ModeHandler.IsTesting) {
                        ...
                        handled =
                            handled || (yield this._insertModeNonRecursive.sendKey(keys, this, this.vimState));
                        handled =
                            handled || (yield this._otherModesNonRecursive.sendKey(keys, this, this.vimState));
                    }
                }
                if (!handled) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            switch (this.currentMode.cursorType) {
                ...
                case mode_1.VSCodeVimCursorType.Native:
                    if (configuration_1.Configuration.userCursor !== undefined) {
                        cursorStyle = configuration_1.Configuration.userCursor;
                    }
                    break;
            }
            const optionalCursorStyle = configuration_1.Configuration.cursorStylePerMode[this._vimState.currentModeName().toLowerCase()];
    ...
    _createCurrentCommandText() {
        ...
        if (this.vimState.currentMode === mode_1.ModeName.EasyMotionInputMode) {
        ...
        if (this._vimState.currentMode === mode_1.ModeName.EasyMotionMode) {
    ...
    setStatusBarColor(color) {
        ...
        vscode.workspace.getConfiguration('workbench').update('colorCustomizations', Object.assign(currentColorCustomizations, {
