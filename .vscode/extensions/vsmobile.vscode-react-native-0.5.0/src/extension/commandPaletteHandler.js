...
class CommandPaletteHandler {
    ...
    static runAndroid(target = "simulator") {
        ...
        return this.selectProject()
            ...
            return this.executeCommandInContext("runAndroid", project.workspaceFolder, () => this.executeWithPackagerRunning(project, () => {
                ...
                const platform = new androidPlatform_1.AndroidPlatform({ platform: "android", workspaceRoot: project.workspaceFolder.uri.fsPath, projectRoot: project.workspaceFolder.uri.fsPath, packagerPort: packagerPort, runArguments: runArgs }, {
    ...
    static runIos(target = "simulator") {
        ...
        return this.selectProject()
            ...
            return this.executeCommandInContext("runIos", project.workspaceFolder, () => this.executeWithPackagerRunning(project, () => {
                ...
                const platform = new iOSPlatform_1.IOSPlatform({ platform: "ios", workspaceRoot: project.workspaceFolder.uri.fsPath, projectRoot: project.workspaceFolder.uri.fsPath, packagerPort, runArguments: runArgs }, { packager: project.packager });
    ...
    static executeCommandInContext(rnCommand, workspaceFolder, operation) {
        return telemetryHelper_1.TelemetryHelper.generate("RNCommand", (generator) => {
            ...
            return reactNativeProjectHelper_1.ReactNativeProjectHelper.isReactNativeProject(workspaceFolder.uri.fsPath).then(isRNProject => {
