...
class IndentObjectMatch extends TextObjectMovement {
    ...
    execAction(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (isChangeOperator) {
                startCharacter = textEditor_1.TextEditor.getLineAt(new position_1.Position(startLineNumber, 0)).firstNonWhitespaceCharacterIndex;
            }
            ...
            const endCharacter = textEditor_1.TextEditor.readLineAt(endLineNumber).length;
            return {
    ...
    static findRangeStartOrEnd(startIndex, cursorIndent, step) {
        ...
        let ret = startIndex;
        const end = step === 1
            ? textEditor_1.TextEditor.getLineCount()
            : -1;
        for (; i !== end; i += step) {
            const line = textEditor_1.TextEditor.getLineAt(new position_1.Position(i, 0));
