            ...
            if (char === "<BS>") {
                ...
                if (!selection.isEmpty) {
                    ...
                    if (line.length > 0 && line.match(/^\s+$/) && configuration_1.Configuration.expandtab) {
                        ...
                        vimState.recordedState.transformations.push({
                            type: "deleteRange",
                            range: new range_1.Range(new position_1.Position(position.line, desiredLineLength), position)
                        });
                    }
                    else {
                        vimState.recordedState.transformations.push({
...
let CommandInsertIndentInCurrentLine = class CommandInsertIndentInCurrentLine extends BaseCommand {
    ...
    exec(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const tabSize = configuration_1.Configuration.tabstop || Number(vscode.window.activeTextEditor.options.tabSize);
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (vimState.currentMode === mode_1.ModeName.Visual ||
                ...
                text = vimState.allCursors.map(range => {
                    ...
                    return vscode.window.activeTextEditor.document.getText(new vscode.Range(start, vimState.currentMode === mode_1.ModeName.Insert ?
                        stop :
                        stop.getRight()));
                }).join("\n");
            }
                ...
                text = vimState.allCursors.map(range => {
                    return vscode.window.activeTextEditor.document.getText(new vscode.Range(range.start.getLineBegin(), range.stop.getLineEnd()));
                }).join("\n");
            }
...
let CommandNextSearchMatch = class CommandNextSearchMatch extends BaseMovement {
    ...
    execAction(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            configuration_1.Configuration.hl = true;
...
var PutCommand_1, MoveRepeatReversed_1, ActionVisualReflowParagraph_1, ToggleCaseOperator_1, CommandSurroundAddToReplacement_1;
