...
var OmniSharpHoverProvider = (function (_super) {
    ...
    OmniSharpHoverProvider.prototype.provideHover = function (document, position, token) {
        ...
        return serverUtils.typeLookup(this._server, req, token).then(function (value) {
            if (value && value.Type) {
                var contents = [documentation_1.extractSummaryText(value.Documentation), { language: 'csharp', value: value.Type }];
