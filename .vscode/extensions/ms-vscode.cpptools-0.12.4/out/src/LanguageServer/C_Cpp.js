...
const ResetDatabase_type = {
    get method() { return "cpptools/resetDatabase"; }
};
...
function activate() {
    ...
    registeredCommands.push(vscode.commands.registerCommand('C_Cpp.ResetDatabase', () => {
        languageClient.sendNotification(ResetDatabase_type);
    }));
