...
On the other hand, [@JimiC](https://github.com/vscode-icons/vscode-icons/blob/master/https;/github.com/JimiC) continues his massive `svg` icon conversion and keeps on providing new quality icons. He's also the creator of the new `Angular project auto-detector` feature released with **v7.1.0**. I'm sure you will like it!
