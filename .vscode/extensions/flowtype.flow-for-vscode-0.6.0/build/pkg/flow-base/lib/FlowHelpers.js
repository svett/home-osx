      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _buildSearchFlowComma = buildSearchFlowCommand(flowPath);
            _command = _buildSearchFlowComma.command;
            _args2 = _buildSearchFlowComma.args;
            _context2.next = 6;
...
var getPathToFlow = function () {
  var _ref5 = _asyncToGenerator(regeneratorRuntime.mark(function _callee3() {
    var config, shouldUseNodeModule, userPath;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            _context3.next = 8;
            return canFindFlow(nodeModuleFlowLocation());
...
function groupParamNames(paramNames) {
  ...
  var _paramNames$reduceRig2 = _slicedToArray(_paramNames$reduceRig, 2);

  var ordinaryParams = _paramNames$reduceRig2[0];
  var trailingOptional = _paramNames$reduceRig2[1];
...
function nodeModuleFlowLocation() {
