...
var ExponentHelper = (function () {
    function ExponentHelper(projectRootPath) {
    ...
    ExponentHelper.prototype.exponentSdk = function (showProgress) {
        ...
        return this.readFromExpJson("sdkVersion")
            ...
            var reactNativeProjectHelper = new reactNativeProjectHelper_1.ReactNativeProjectHelper(_this.rootPath);
    ...
    ExponentHelper.prototype.usingReactNativeExponent = function (showProgress) {
        ...
        var pathToReactNativePackageJson = path.resolve(this.rootPath, "node_modules", "react-native", "package.json");
    ...
    ExponentHelper.prototype.getPackageName = function () {
        return new package_1.Package(this.rootPath, { fileSystem: this.fileSystem }).name();
    };
    /**
    ...
    ExponentHelper.prototype.lazilyInitialize = function () {
        if (!this.hasInitialized) {
            ...
            this.commandExecutor = new commandExecutor_1.CommandExecutor(this.rootPath);
