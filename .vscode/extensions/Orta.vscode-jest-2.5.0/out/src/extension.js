...
function activate(context) {
    ...
    const pluginSettings = {
        ...
        runAllTestsFirst: workspaceConfig.get('runAllTestsFirst'),
    };
    ...
    context.subscriptions.push(statusBar_1.registerStatusBar(channel), vscode.commands.registerTextEditorCommand(`${appGlobals_1.extensionName}.start`, () => {
        ...
        channel.show();
    }), ...fileChangeWatchers_1.registerFileChangeWatchers(extensionInstance), ...Coverage_1.registerCoverageCodeLens(extensionInstance), Coverage_1.registerToggleCoverageOverlay(), vscode.commands.registerCommand(`${appGlobals_1.extensionName}.run-test`, extensionInstance.runTest), vscode.languages.registerCodeLensProvider(languages, extensionInstance.codeLensProvider));
}
