...
var projectRootPath = settingsHelper_1.SettingsHelper.getReactNativeProjectRoot();
var workspaceRootPath = vscode.workspace.rootPath;
var globalPackager = new packager_1.Packager(workspaceRootPath, projectRootPath);
var packagerStatusIndicator = new packagerStatusIndicator_1.PackagerStatusIndicator();
var globalExponentHelper = new exponentHelper_1.ExponentHelper(workspaceRootPath, projectRootPath);
...
function setupReactNativeDebugger() {
    ...
    var vsCodeFolder = path.join(workspaceRootPath, ".vscode");
