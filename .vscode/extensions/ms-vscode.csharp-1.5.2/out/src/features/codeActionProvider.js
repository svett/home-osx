...
var OmnisharpCodeActionProvider = (function (_super) {
    ...
    OmnisharpCodeActionProvider.prototype.provideCodeActions = function (document, range, context, token) {
        ...
        return serverUtils.getCodeActions(this._server, req, token).then(function (response) {
            return response.CodeActions.map(function (codeAction) {
                return {
    ...
    OmnisharpCodeActionProvider.prototype._runCodeAction = function (req) {
        return serverUtils.runCodeAction(this._server, req).then(function (response) {
