	...
	_createClass(HoverSupport, [{
		...
		value: function () {
			var _ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee(document, position) {
				var fileName, wordPosition, word, currentContents, line, col, completions;
					...
					while (1) {
						switch (_context.prev = _context.next) {
							...
							case 10:
								...
								return _context.abrupt('return', new vscode.Hover(['[Flow]', { language: 'javascript', value: word + ': ' + completions.type }]));
