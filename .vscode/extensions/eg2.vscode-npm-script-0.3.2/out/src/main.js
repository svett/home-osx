...
function isYarnManaged(document) {
    return __awaiter(this, void 0, void 0, function* () {
        return new Promise((resolve, _reject) => {
            const root = vscode_1.workspace.getWorkspaceFolder(document.uri).uri.fsPath;
            if (!root) {
...
function isMultiRoot() {
    return vscode_1.workspace.workspaceFolders && vscode_1.workspace.workspaceFolders.length > 1;
}
...
function commandDescriptionsInPackage(param, packagePath, descriptions) {
    ...
    const rootUri = vscode_1.workspace.getWorkspaceFolder(fileUri).uri;
