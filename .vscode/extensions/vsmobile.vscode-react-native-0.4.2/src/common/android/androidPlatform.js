...
const outputVerifier_1 = require("../outputVerifier");
...
class AndroidPlatform extends generalMobilePlatform_1.GeneralMobilePlatform {
    ...
    constructor(runOptions, { remoteExtension, adb = new adb_1.Adb(), } = {}) {
    ...
    runApp(shouldLaunchInAllDevices = false) {
        return telemetryHelper_1.TelemetryHelper.generate("AndroidPlatform.runApp", () => {
            ...
            const runAndroidSpawn = new commandExecutor_1.CommandExecutor(this.projectPath).spawnReactCommand("run-android", runArguments);
