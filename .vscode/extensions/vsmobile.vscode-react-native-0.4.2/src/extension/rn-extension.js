...
const packagerPort = configurationReader_1.ConfigurationReader.readIntWithDefaultSync(packager_1.Packager.DEFAULT_PORT, settingsHelper_1.SettingsHelper.getPackagerPort());
