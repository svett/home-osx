...
class CommandPaletteHandler {
    ...
    runAndroid(target = "simulator") {
        ...
        return this.executeCommandInContext("runAndroid", () => this.executeWithPackagerRunning(() => {
            ...
            return new androidPlatform_1.AndroidPlatform({ platform: "android", projectRoot: this.workspaceRoot, packagerPort: packagerPort, runArguments: runArgs }).runApp(/*shouldLaunchInAllDevices*/ true);
        }));
    }
    /**
    ...
    runIos(target = "simulator") {
        ...
        return this.executeCommandInContext("runIos", () => {
            ...
            return new iOSDebugModeManager_1.IOSDebugModeManager(this.workspaceRoot)
    ...
    executeReactNativeRunCommand(command, args = []) {
        return this.executeWithPackagerRunning(() => {
            return new commandExecutor_1.CommandExecutor(this.workspaceRoot)
