...
class ModeHandler {
    ...
    updateView(vimState, args = { drawSelection: true, revealRange: true }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let cursorStyle = this.currentMode.cursorType === mode_1.VSCodeVimCursorType.Native &&
            ...
            */
            ...
            if ((configuration_1.Configuration.incsearch && this.currentMode.name === mode_1.ModeName.SearchInProgressMode) ||
                ((configuration_1.Configuration.hlsearch && configuration_1.Configuration.hl) && vimState.globalState.searchState)) {
