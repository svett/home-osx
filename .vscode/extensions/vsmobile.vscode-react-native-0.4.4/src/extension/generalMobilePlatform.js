...
class GeneralMobilePlatform {
    constructor(runOptions, platformDeps = {}) {
        ...
        this.packager = platformDeps.packager || new packager_1.Packager(vscode.workspace.rootPath, this.projectPath, settingsHelper_1.SettingsHelper.getPackagerPort());
