...
Besides that, [@JimiC](https://github.com/robertohuertasm/vscode-icons/blob/master/https;/github.com/JimiC) along with [@ginfuru](https://github.com/ginfuru) are continuing to contribute to the massive `svg` icon conversion and providing new quality icons.
...
See [here the supported icon extensions](https://github.com/robertohuertasm/vscode-icons/blob/master/(https://github.com/robertohuertasm/vscode-icons/blob/master/src/models/extensions/fileFormat.ts)).
